...
export const services: ServiceData[] = [
	{
		...
		faqs: [
			{
				question: '¿Cada cuánto debo visitar al dentista para una revisión general?',
				answer:
			...
			{
				question: '¿Qué diferencia hay entre una limpieza simple y una profunda?',
				answer:
	...
	},
	{
		...
		faqs: [
			{
				question: '¿A qué edad se debe llevar a un niño al ortodoncista por primera vez?',
				answer:
