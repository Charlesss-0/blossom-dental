...
export function Services({ limit, showTitle = true, className }: ServicesProps) {
				...
				{showTitle && (
					<FadeIn className="max-w-3xl mx-auto mb-16 text-center">
						...
						<p className="text-lg leading-relaxed text-gray-600">
							Ofrecemos una gama completa de tratamientos dentales adaptados a las necesidades de
							cada paciente, desde cuidados preventivos hasta procedimientos especializados.
						</p>
					</FadeIn>
				)}
										...
										>
											...
											<div
												className={`w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center transition-all duration-300 ${
													isActive ? 'bg-gray-900 border-gray-900 rotate-180' : 'bg-white'
												}`}
											>
												{isActive ? (
