				...
				<div className="items-center grid grid-cols-1 gap-16 md:grid-cols-2">
					...
					<FadeIn delay={0.2}>
						...
						<h2 className="mb-8 font-serif text-4xl leading-tight text-gray-900 md:text-5xl">
							...
							<br />
							<span className="italic text-gray-600">con Enfoque Personalizado</span>
						</h2>

						<div className="leading-relaxed text-gray-700 space-y-6 md:text-lg">
							<p>
								Cada tratamiento en Blossom Dental comienza con una evaluación detallada y una
								explicación clara de las opciones disponibles, para que puedas tomar decisiones
								informadas sobre tu salud dental.
							</p>
							<p>
								Utilizamos tecnología moderna para garantizar diagnósticos precisos y tratamientos
								eficientes, siempre manteniendo un trato cercano y respetuoso.
							</p>
						</div>
