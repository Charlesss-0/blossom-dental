				...
				<div className="container px-6 mx-auto md:px-12">
					<FadeIn className="max-w-3xl mx-auto text-center">
						...
						<p className="mb-8 text-lg leading-relaxed text-gray-600 md:text-xl">
							En Blossom Dental, nos enorgullece ofrecer una atención integral para cuidar cada
							aspecto de tu salud bucal. Desde limpiezas preventivas hasta rehabilitaciones
							completas, nuestro equipo en Managua utiliza las mejores técnicas y tecnología para
				...
				<div className="container px-6 mx-auto text-center md:px-12">
					<FadeIn>
						...
						<p className="max-w-2xl mx-auto mb-8 text-lg text-gray-700">
							Agenda tu cita hoy y déjanos cuidar de tu salud dental con la calidez y
							profesionalismo que nos distingue.
						</p>
