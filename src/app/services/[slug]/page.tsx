					...
					<div className="items-center grid gap-12 lg:grid-cols-2 lg:gap-20">
						<FadeIn>
							...
							<div className="flex flex-wrap gap-4">
								...
								<Button variant="outline" size="lg" className="px-8 text-base rounded-full" asChild>
					...
					<div className="items-center grid gap-12 lg:grid-cols-2 lg:gap-24">
						<FadeIn>
							...
							<p className="mb-8 text-lg text-gray-300">
								Si experimentas alguno de los siguientes síntomas o situaciones, es probable que
								este sea el tratamiento ideal para ti.
							</p>
							<WhatsAppCTA>
								<Button
									size="lg"
			...
			<section className="py-20 lg:py-28">
				<div className="container px-6 mx-auto md:px-12">
					<FadeIn className="max-w-3xl mx-auto text-center">
						...
						<p className="mb-12 text-lg leading-relaxed text-gray-600">{service.ourApproach}</p>
					</FadeIn>
				</div>
			</section>
			...
			<section className="py-20">
				<div className="container px-6 mx-auto md:px-12">
					<div className="mb-12 text-center">
						<h3 className="font-serif text-3xl text-gray-900">Otros Servicios</h3>
					</div>
